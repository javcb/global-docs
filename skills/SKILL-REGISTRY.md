...
## Orchestration Skills (In Development)

Orchestration skills chain multiple skills together for end-to-end workflows.

| Skill Name | File Path | Current Version | Status | Estimated | Dependencies | Domains | Description |
|---|---|---|---|---|---|---|---|
| **Project Kickoff** | `skills/orchestration/skill-project-kickoff/` | TBD | PLANNED | Phase 4F | prompting-core, solution-assessment, doc-classifier | All | End-to-end: idea → solution assessment → domain context check → SPEC creation → execution readiness → launch. |
| **Standards-Wide Audit** | `skills/orchestration/skill-standards-wide-audit/` | TBD | PLANNED | Phase 4G | audit-trigger | All | Cross-repo orchestration: audit all standards repos, consolidate findings, produce single priority list. |
